...
const Reminder = {
    create : async (data) => {
        const sql = `
        INSERT INTO TABLE reminders (user_id, medication_id, reminder_time, days_of_the_week, is_active)
    ...
    findByUserId: async (userId) => {
        const sql = `SELECT * FROM reminders WHERE id = $1 ORDER_BY reminder_time`;
